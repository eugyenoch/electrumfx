...
<head>
	<title>Electrum FX | Cookie Policy Documentation</title>
	<meta charset="UTF-8" />
	<meta name="title" content="Electrum FX | Cookie Policy" />
	<meta name="Description" content="View the Electrum FX cookie policy on this page" />
	<meta name="keywords" content="Electrum FX cookie policy,Earn money online, Make money online, bitcoin wallets, Education,Elearning,SME Training,Online Training,E-Learning,Manual Handling,Online Education" />
	<meta name="viewport" 
	...
	<meta property="og:title" content="Electrum FX | Cookie Policy" />
	<meta property="og:description" content="View the Electrum FX cookie policy on this page" />
...
<p>
    A cookie is a tiny text file stored on your computer. Cookies store information that is used to help make sites work. Only we can access the cookies created by our website. You can control your cookies at the browser level. Choosing to disable cookies may hinder your use of certain functions.</p>
    <p>
...
<h2>Cookies set by Electrum FX and other third party App</h2>
<p>The Electrum FX website also makes use of services offered by third party websites such as Jetpack, and webmaster tools amongst others to enhance the experience of visitors. These include social media platforms such as Facebook and Twitter (through the use of sharing buttons). As a result, cookies may be set by these third parties, and used by them to track your online activity. We have no direct control over the information that is collected by these cookies.<br>
Cookies are used by Electrum FX and other third party Apps running on the Electrum FX website in a variety of different ways. The cookies set will depend features that are enabled. The cookies are only set when a user interacts with one of these, or to allow admin functions.</p>
