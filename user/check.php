...
<title>Confirm Email Address | Electrum FX</title>
...
<div class="login-box sty1">
  ...
  <div class="login-logo">
    <a href="../index.php"><span class="lead cursive">Electrum<span style="border: 3px solid #FF880E; border-radius:50%;margin-left:1px; padding:2px; background:#FF880E; color:#fff;">FX</span></a>
  </div>
    ...
    <form action="<?php htmlentities($_SERVER['PHP_SELF']);?>" method="post" name="loginForm">
      <div class="form-group has-feedback">
        <input type="email" class="form-control sty1" placeholder="email address" name="user" title="Enter your registered email address" required><br>
      </div>
      <div>
        <div class="col-xs-8">
        <!-- /.col -->
        <div class="col-xs-4 m-t-1">
          <button type="submit" class="btn btn-lg btn-block btn-flat" style="background:#FF880E; color:#fff;" name="confirm">Confirm</button>
        </div>
        <!-- /.col --> 
      </div>
    </form>
