...
if(isset($_POST['uProfile'])){
  ...
  $sql_profile_update = "UPDATE `users` SET `firstname` = '$eFname', `lastname` = '$eLname',`address` = '$eAddress', `city` = '$city',`country` = '$eCountry', `phone` = '$ePhone' WHERE `users`.`user_email` = '$user_email'";
...
if(isset($_POST['uPwd'])){
    if($pass===$cpass){
        $sql = "UPDATE `users` SET `user_pass` = '$pass' WHERE `users`.`user_email`='$user_email'";
...
if(in_array($file_ext,$extensions)=== false){
      ...
      if(empty($errors)==true) {
         ...
         $sql_insert_photo = "UPDATE `users` SET `photo`='$file_name' WHERE `user_email`='$user_email' ";
                  ...
                  <div class="card-body">
                    ...
                    <form class="form-horizontal form-material" method="POST" action="<?= htmlentities($_SERVER['PHP_SELF']);?>">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-12">
                          <input placeholder="Enter new password" class="form-control form-control-line" type="password" name="ePass"><span class="note"><small>Use secure passwords</small></span>
