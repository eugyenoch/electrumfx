        ...
        <li><a href="https://electrumfx.org/docs/privacy-policy.php">Privacy Policy</a></li>
                ...
                <div class="col-md-4 mt-2 mt-sm-0">
                    <div class="d-flex justify-content-between justify-content-md-end align-items-center guttar-25px pdt-0-5x pdb-0-5x">
                        <div class="copyright-text"><p style="padding:10px 0 !important;"><center><small>©&nbsp;<?= date('Y');?>&nbsp;<a href="../index.php"><span class="lead cursive">Electrum<span style="border: 3px solid #FF880E; border-radius:50%;margin-left:1px; padding:2px; background:#FF880E; color:#fff;">FX</span></span></a> | All rights reserved.&nbsp;<!-- Electrum FX - The easiest place to invest bitcoin. -->Electrum FX is a registered investment platform providing digital asset investment management services to individuals, lending and investment, multicurrency and multifunctional online platform based on blockchain technology.</small></center></p></div>
                    </div>
                </div>
                <!-- .col -->
            </div>
