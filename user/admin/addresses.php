...
<table class="table-responsive">
    <tr>
        <td class="">         
            <input class="form-control form-control-line" type="text" name="newWallet" placeholder="short name(e.g BTC, ETH)" required>
        </td>
        <td>
            <input class="form-control form-control-line" type="text" name="newAddressLong" placeholder="long name(e.g Bitcoin, Ethereum)" required>
        </td>
        <td>
            <input class="form-control form-control-line" type="text" name="newAddress" placeholder="wallet address" required>
        </td>
...
if(isset($_POST['addNewAddress'])){
    ...
    $newAddressLong = sanitize($_POST['newAddressLong']);

    $Sql_addNewAddress = "INSERT INTO `addresses`(`wallets`,`addresses`,`address_longname`) VALUES('$newWallet','$newAddress','$newAddressLong')";
    if($con->query($Sql_addNewAddress)){$toast="addNewSuccess";}
...
if(isset($toast) && $toast==='addNewSuccess'){echo "<script>toastr.success('You have added a new wallet. Refresh the page to see it', 'Success')</script>";}
