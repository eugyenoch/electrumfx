                  ...
                  <div class="card-body">
                    ...
                    <form class="form-horizontal form-material" method="POST" action="<?= htmlentities($_SERVER['PHP_SELF']);?>">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-12">
                          <input placeholder="Enter new password" class="form-control form-control-line" type="password" name="ePass"><span class="note"><small>Secure passwords only</small></span>
