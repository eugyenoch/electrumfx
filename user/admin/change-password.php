...
<title> Change Password | Electrum FX</title>
...
<div class="login-box sty1">
  ...
  <div class="login-logo">
   <a href="#"><span class="lead cursive">ZenithBroker<span class="orange">Trade</span><!-- <img src="dist/img/p2pdark.png" width="" height="" alt="Electrum FX" title="Electrum FX"> --></a>
  </div>
    ...
    <form action="<?php htmlentities($_SERVER['PHP_SELF']);?>" method="post" name="changePassword">
      <div class="form-group has-feedback">
        <input type="password" class="form-control sty1" placeholder="Password" name="pwd" required><span class="note"><small>We recommend you choose a secure password</small></span>
      ...
      <div>
        ...
        <div class="col-xs-4 m-t-1">
          <button type="submit" class="btn btn-lg btn-block btn-flat" style="background:#FF880E; color:#fff;" name="reset">Change Password</button>
        </div>
        <!-- /.col --> 
      </div>
    </form>
