        ...
        <div class="topbar is-sticky">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <!-- .topbar-nav -->
                    <a class="topbar-logo" href="index.php"><span class="lead cursive">Electrum<span style="border: 3px solid #FF880E; border-radius:50%;margin-left:1px; padding:2px;" class="orange">FX</span></span></a>
                    <ul class="topbar-nav">
                        <li class="topbar-nav-item relative"><span class="user-welcome d-none d-lg-inline-block">Hello&nbsp;<?php if(isset($firstname) && isset($lastname)){echo $firstname."&nbsp;".$lastname;}?></span><a class="toggle-tigger user-thumb" href="#"><img src="<?php if(isset($profile_photo) && $profile_photo!==null){echo $profile_photo;}?>"><i class="fa fa-user"></i></a>
                            <div class="toggle-class dropdown-content dropdown-content-right dropdown-arrow-right user-dropdown dds">
                                ...
                                <ul class="user-links">
                 <li><a href="https://electrumfx.org/user/edit-profile.php"><i class="fa fa-user"></i>&nbsp;Edit Profile</a>
                                    </li>
                <li><a href="https://electrumfx.org/user/edit-profile.php"><i class="fa fa-key"></i>&nbsp;Reset Password</a>
                                    </li>
                                </ul>
                            ...
                            <div class="select-wrapper">
                                <select class="input-bordered" name="currency_id">
                                    <?php foreach($sql_addresses_exec as $addresses_info){extract($addresses_info);?>
                                        <option value="<?= $addresses_info['wallets'];?>"><?= $addresses_info['wallets'] ." - ". $addresses_info['address_longname'];?></option><?php }?>
                                    </select>
                            </div>
                        </div>
                        <div class="input-item input-with-label">
