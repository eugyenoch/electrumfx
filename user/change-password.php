  ...
  <div class="login-logo">
    ...
    <form action="<?php htmlentities($_SERVER['PHP_SELF']);?>" method="post" name="changePassword">
      <div class="form-group has-feedback">
        <input type="password" class="form-control sty1" placeholder="Password" name="pwd" title="Choose a secure password" required><span class="note"><small>We recommend you choose a secure password</small></span>
